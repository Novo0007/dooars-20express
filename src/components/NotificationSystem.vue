<template>
  <teleport to="body">
    <div class="fixed top-4 right-4 z-50 space-y-3 max-w-sm">
      <transition-group name="notification" tag="div" @enter="onEnter" @leave="onLeave">
        <div
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              <h4 v-if="notification.title" class="font-semibold text-sm">
                {{ notification.title }}
              </h4>
...
const getIconClasses = (type: string) => {
  switch (type) {
    case 'success':
      return 'w-5 h-5 text-green-500 dark:text-green-400'
    case 'warning':
      return 'w-5 h-5 text-yellow-500 dark:text-yellow-400'
    case 'error':
      return 'w-5 h-5 text-red-500 dark:text-red-400'
    case 'info':
      return 'w-5 h-5 text-blue-500 dark:text-blue-400'
    default:
      return 'w-5 h-5 text-gray-500 dark:text-gray-400'
  }
}
