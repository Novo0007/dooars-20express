  ...
  >
    <div class="flex items-center justify-around py-2">
      ...
      <router-link 
        ...
        :class="$route.path === '/' ? 'text-primary-600 dark:text-primary-400' : 'text-neutral-500 dark:text-neutral-400'"
      >
        <div class="relative">
          <svg 
      ...
      <router-link 
        to="/search" 
        class="flex flex-col items-center justify-center p-3 min-h-[60px] min-w-[60px] transition-colors duration-200"
        :class="$route.path === '/search' ? 'text-primary-600 dark:text-primary-400' : 'text-neutral-500 dark:text-neutral-400'"
      >
        <div class="relative">
          <svg 
            class="w-6 h-6 mb-1 transition-transform duration-200" 
      ...
      <router-link 
        to="/booking-history" 
        class="flex flex-col items-center justify-center p-3 min-h-[60px] min-w-[60px] transition-colors duration-200"
        :class="$route.path === '/booking-history' ? 'text-primary-600 dark:text-primary-400' : 'text-neutral-500 dark:text-neutral-400'"
      >
        <div class="relative">
          <svg 
            class="w-6 h-6 mb-1 transition-transform duration-200" 
      ...
      <router-link 
        to="/favorites" 
        class="flex flex-col items-center justify-center p-3 min-h-[60px] min-w-[60px] transition-colors duration-200"
        :class="$route.path === '/favorites' ? 'text-primary-600 dark:text-primary-400' : 'text-neutral-500 dark:text-neutral-400'"
      >
        <div class="relative">
          <svg 
            class="w-6 h-6 mb-1 transition-transform duration-200" 
            :class="[$route.path === '/favorites' ? 'scale-110' : '', $route.path === '/favorites' ? 'fill-current' : '']"
            fill="none" 
            stroke="currentColor" 
            viewBox="0 0 24 24"
          >
      ...
      <router-link 
        to="/profile" 
        class="flex flex-col items-center justify-center p-3 min-h-[60px] min-w-[60px] transition-colors duration-200"
        :class="$route.path === '/profile' ? 'text-primary-600 dark:text-primary-400' : 'text-neutral-500 dark:text-neutral-400'"
      >
        <div class="relative">
          <!-- User Avatar or Icon -->
          <div v-if="authStore.isAuthenticated && authStore.user?.profile?.avatar_url" class="w-6 h-6 mb-1 rounded-full overflow-hidden">
            <img 
        ...
        <span class="text-xs font-medium">{{ authStore.isAuthenticated ? $t('nav.profile') : $t('nav.login') }}</span>
      </router-link>
    </div>
