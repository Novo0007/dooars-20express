<template>
  <!-- Mobile Navigation -->
  <nav
    class="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40"
  >
    <!-- Top Bar -->
    <div class="px-4 py-3">
    ...
    >
      <div
        v-if="isMobileMenuOpen"
        class="fixed right-0 top-0 bottom-0 w-80 max-w-[90vw] bg-white dark:bg-gray-800 shadow-xl z-50 overflow-y-auto"
      >
        <!-- Menu Header -->
