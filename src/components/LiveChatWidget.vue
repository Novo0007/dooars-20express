<template>
  ...
  >
    <!-- Chat Header -->
    <div class="bg-primary-600 dark:bg-primary-700 text-white p-4 flex items-center justify-between">
    ...
    >
      ...
      <div v-if="messages.length === 0" class="text-center py-8">
        <div class="w-12 h-12 bg-primary-100 dark:bg-primary-900 rounded-full mx-auto mb-3 flex items-center justify-center">
          <svg class="w-6 h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
          </svg>
        </div>
        <p class="text-sm text-neutral-600 dark:text-neutral-400">{{ $t('chat.startConversation') }}</p>
      </div>
      ...
      >
        ...
        >
          ...
          <p 
            ...
            :class="message.sender === 'user' ? 'text-primary-100' : 'text-neutral-500 dark:text-neutral-400'"
          >
