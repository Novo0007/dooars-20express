  ...
  >
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-white">
      ...
      <p class="text-blue-100 text-sm mt-1">
        Complete your booking with trusted Indian payment options
      </p>
    </div>
    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-600">
      <div class="space-y-3">
        ...
        <div
          v-if="paymentDetails.discount > 0"
    ...
    <div class="p-6">
      ...
      <div class="mt-6 flex flex-col sm:flex-row gap-3">
        ...
        >
          ...
          <span v-else> Pay {{ formatCurrency(paymentDetails.totalAmount) }} </span>
        </button>
      </div>
    </div>
  </div>
...
const isFormValid = computed(() => {
  return (
    customerInfo.value.name.length > 0 &&
