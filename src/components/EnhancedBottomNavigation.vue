<template>
  <div class="md:hidden">
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-lg border-t border-neutral-200 dark:border-neutral-700 z-50 safe-area-inset">
      <div class="flex items-center justify-around py-1">
        ...
        <NavigationItem 
          ...
          :initials="authStore.isAuthenticated ? authStore.userDisplayName.charAt(0).toUpperCase() : ''"
        />
      </div>
    </nav>
    ...
    return () => h('router-link', 
      ...
      [
        ...
        h('div', { class: 'relative mb-1' }, [
          ...
          props.initials ? 
            h('div', {
              class: 'w-6 h-6 rounded-full bg-primary-600 dark:bg-primary-400 flex items-center justify-center text-white text-xs font-semibold'
            }, props.initials) :
            h(props.icon!, {
              class: [
          ...
          props.badge && props.badge > 0 && h('div', {
