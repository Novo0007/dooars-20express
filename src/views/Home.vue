<template>
  <div class="min-h-screen">
    ...
    <section
      class="relative bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-600 overflow-hidden"
    >
      <!-- Background Pattern -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div class="lg:col-span-1">
                <label
                  ...
                  >{{ $t('home.search.destination') }}</label
                >
                <div class="relative">
                  <input
                  ...
                  />
                  <svg
                    class="absolute right-3 top-3.5 w-5 h-5 text-neutral-400"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          >
            ...
            <div class="absolute bottom-6 left-6 text-white">
              ...
              <p class="text-white/90 text-sm">
                {{ destination.properties }} {{ $t('home.destinations.properties') }}
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="py-20 bg-white dark:bg-neutral-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div
              class="w-16 h-16 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl mx-auto mb-6 flex items-center justify-center"
            >
            ...
            <h3 class="font-display font-bold text-xl text-neutral-800 dark:text-neutral-200 mb-4">
...
const getFeatureTitle = (id: number) => {
  switch (id) {
    case 1:
      return t('home.features.priceGuarantee.title')
    case 2:
      return t('home.features.support.title')
    case 3:
      return t('home.features.secure.title')
    default:
      return ''
  }
}
...
const getFeatureDescription = (id: number) => {
  switch (id) {
    case 1:
      return t('home.features.priceGuarantee.description')
    case 2:
      return t('home.features.support.description')
    case 3:
      return t('home.features.secure.description')
    default:
      return ''
  }
}
