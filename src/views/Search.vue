<template>
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-900">
    <!-- Search Header -->
    <div class="bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700 py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div>
            ...
            <p class="text-neutral-600 dark:text-neutral-400 mt-1">
              {{ searchFilters.destination || 'All destinations' }} • {{ searchFilters.guests }} {{ $t('home.search.guests').toLowerCase() }}
            </p>
          </div>
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-1">
                <button
                  ...
                  :class="searchFilters.amenities.includes(amenity) 
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6" :class="{ 'lg:col-span-2': !showMap }">
          ...
          <div v-if="loading" class="grid gap-6">
            <div v-for="i in 3" :key="i" class="bg-white dark:bg-neutral-800 rounded-xl p-6 animate-pulse">
          ...
          <div v-else class="space-y-6">
            ...
            >
              <div class="flex flex-col sm:flex-row">
                <div class="relative sm:w-48 h-48 sm:h-auto overflow-hidden sm:rounded-l-xl rounded-t-xl sm:rounded-tr-none">
                  <img 
                    :src="hotel.image" 
                    :alt="hotel.name"
                  ...
                  <div class="absolute top-3 left-3">
                    <span class="bg-accent-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
                      {{ hotel.badge }}
                    </span>
                  </div>
                  <div class="absolute top-3 right-3">
                    <span class="bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-semibold text-neutral-800">
                      ⭐ {{ hotel.rating }}
                    </span>
                  </div>
                </div>
                ...
                <div class="flex-1 p-6">
                  <div class="flex justify-between items-start mb-2">
                    <h3 class="font-display font-bold text-xl text-neutral-800 dark:text-neutral-200">
                      {{ hotel.name }}
                    </h3>
                  ...
                  <p v-if="hotel.description" class="text-neutral-600 dark:text-neutral-400 text-sm mb-4">
                    {{ hotel.description }}
                  </p>
                  ...
                  <div v-if="hotel.amenities" class="flex flex-wrap gap-1 mb-4">
                    ...
                    <span v-if="hotel.amenities.length > 4" class="text-xs text-neutral-500 dark:text-neutral-400 px-2 py-1">
                      +{{ hotel.amenities.length - 4 }} more
                    </span>
                  </div>
                  
                  <div class="flex items-center justify-between">
                    <button class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium text-sm transition-colors duration-200">
...
const popularAmenities = ref(['WiFi', 'Pool', 'Spa', 'Gym', 'Restaurant', 'Bar', 'Parking', 'Pet Friendly'])
...
const onMarkerClick = (marker: any) => {
  const hotel = filteredResults.value.find(h => 
    h.coordinates && 
