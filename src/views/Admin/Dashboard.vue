        ...
        >
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <div class="flex items-center justify-center h-8 w-8 rounded-md" :class="stat.iconBg">
                <svg
                  class="h-5 w-5"
                ...
                <dd class="flex items-baseline">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 20 20"
                    >
                      <path fill-rule="evenodd" :d="stat.changePath" clip-rule="evenodd" />
                    </svg>
                    <span class="sr-only"
                      >{{ stat.changeType === 'increase' ? 'Increased' : 'Decreased' }} by</span
                    >
                    {{ stat.change }}
                  </div>
                </dd>
...
const calculateStats = async () => {
  try {
    ...
    const totalRevenue =
      revenueData?.reduce((sum, booking) => sum + (booking.final_price || 0), 0) || 0
