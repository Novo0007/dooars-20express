  ...
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-900 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl lg:text-4xl font-display font-bold text-neutral-800 dark:text-neutral-200 mb-4">
      ...
      <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft border border-neutral-200 dark:border-neutral-700 overflow-hidden mb-8">
        <!-- Header -->
        ...
        <div class="p-6">
          ...
          <div class="flex space-x-4 mb-6 pb-6 border-b border-neutral-200 dark:border-neutral-700">
            ...
            />
            <div class="flex-1">
              <h3 class="font-display font-bold text-xl text-neutral-800 dark:text-neutral-200 mb-1">
              ...
              <div class="flex items-center">
                ...
                <span class="text-neutral-600 dark:text-neutral-400">{{ mockBooking.hotel.rating }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4">
              <div class="text-sm text-neutral-600 dark:text-neutral-400 mb-1">{{ $t('booking.checkin') }}</div>
              <div class="font-semibold text-neutral-800 dark:text-neutral-200">{{ formatDate(mockBooking.checkIn) }}</div>
              <div class="text-sm text-neutral-600 dark:text-neutral-400">{{ $t('confirmation.from15') }}</div>
            </div>

            <!-- Check-out -->
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4">
              <div class="text-sm text-neutral-600 dark:text-neutral-400 mb-1">{{ $t('booking.checkout') }}</div>
              <div class="font-semibold text-neutral-800 dark:text-neutral-200">{{ formatDate(mockBooking.checkOut) }}</div>
              <div class="text-sm text-neutral-600 dark:text-neutral-400">{{ $t('confirmation.until11') }}</div>
            </div>

            <!-- Duration -->
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4">
              <div class="text-sm text-neutral-600 dark:text-neutral-400 mb-1">{{ $t('booking.duration') }}</div>
            ...
            <!-- Guests -->
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4">
              <div class="text-sm text-neutral-600 dark:text-neutral-400 mb-1">{{ $t('booking.guests') }}</div>
              <div class="font-semibold text-neutral-800 dark:text-neutral-200">
                {{ mockBooking.guests }} {{ mockBooking.guests === 1 ? $t('booking.guest') : $t('booking.guests') }}
              </div>
            </div>
          </div>
          ...
          <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            <h4 class="font-semibold text-blue-800 dark:text-blue-200 mb-2">{{ $t('booking.roomType') }}</h4>
            <p class="text-blue-700 dark:text-blue-300">{{ mockBooking.roomType }}</p>
          </div>

          <!-- Guest Information -->
          <div class="border-t border-neutral-200 dark:border-neutral-700 pt-6">
            <h4 class="font-semibold text-neutral-800 dark:text-neutral-200 mb-4">{{ $t('booking.guestInformation') }}</h4>
      ...
      <!-- Payment Summary -->
      <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft border border-neutral-200 dark:border-neutral-700 p-6 mb-8">
        ...
        <div class="space-y-3 text-sm">
          <div class="flex justify-between">
            ...
            <span class="text-neutral-800 dark:text-neutral-200">${{ mockBooking.totalPrice }}</span>
          </div>
          <div class="flex justify-between">
          ...
          <div class="border-t border-neutral-200 dark:border-neutral-700 pt-3 flex justify-between font-semibold">
            ...
            <span class="text-xl text-green-600 dark:text-green-400">${{ mockBooking.finalPrice }}</span>
          </div>
        </div>
        ...
        <div class="mt-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-green-800 dark:text-green-200 font-medium">{{ $t('confirmation.paymentSuccessful') }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft border border-neutral-200 dark:border-neutral-700 p-6 mb-8">
        ...
        <div class="space-y-4">
          <div class="flex items-start space-x-3">
            <div class="w-6 h-6 bg-primary-600 text-white rounded-full flex items-center justify-center text-sm font-semibold flex-shrink-0">1</div>
            <div>
              <h4 class="font-medium text-neutral-800 dark:text-neutral-200">{{ $t('confirmation.step1Title') }}</h4>
              <p class="text-sm text-neutral-600 dark:text-neutral-400">{{ $t('confirmation.step1Description') }}</p>
            </div>
          </div>
          
          <div class="flex items-start space-x-3">
            <div class="w-6 h-6 bg-primary-600 text-white rounded-full flex items-center justify-center text-sm font-semibold flex-shrink-0">2</div>
            <div>
              <h4 class="font-medium text-neutral-800 dark:text-neutral-200">{{ $t('confirmation.step2Title') }}</h4>
              <p class="text-sm text-neutral-600 dark:text-neutral-400">{{ $t('confirmation.step2Description') }}</p>
            </div>
          </div>
          
          <div class="flex items-start space-x-3">
            <div class="w-6 h-6 bg-primary-600 text-white rounded-full flex items-center justify-center text-sm font-semibold flex-shrink-0">3</div>
            <div>
              <h4 class="font-medium text-neutral-800 dark:text-neutral-200">{{ $t('confirmation.step3Title') }}</h4>
              <p class="text-sm text-neutral-600 dark:text-neutral-400">{{ $t('confirmation.step3Description') }}</p>
            </div>
          </div>
        </div>
      </div>
