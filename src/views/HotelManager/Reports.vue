  ...
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-900 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8 bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
        <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-4">Select Hotel & Date Range</h3>
      ...
      <div v-if="selectedHotelId && reportData.bookings.length > 0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">{{ reportData.summary.totalBookings }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">${{ reportData.summary.totalRevenue.toLocaleString() }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Avg. Daily Rate</p>
                <p class="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">${{ reportData.summary.avgDailyRate }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">{{ reportData.summary.occupancyRate }}%</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <!-- Revenue Chart -->
          <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
            <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-4">Daily Revenue</h3>
            <div class="h-64 flex items-center justify-center border-2 border-dashed border-neutral-300 rounded-lg">
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
            <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-4">Booking Status Distribution</h3>
            <div class="h-64">
              <div class="space-y-3">
                <div
                ...
                >
                  <div class="flex items-center">
                    ...
                    ></div>
                    <span class="text-sm font-medium text-neutral-900 dark:text-neutral-100">{{ status.name }}</span>
                  </div>
                  <div class="flex items-center">
                    <span class="text-sm text-neutral-600 dark:text-neutral-400 mr-2">{{ status.count }}</span>
        ...
        <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft border border-neutral-200 dark:border-neutral-700 overflow-hidden mb-8">
          <div class="px-6 py-4 border-b border-neutral-200 dark:border-neutral-700">
            <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100">Room Performance</h3>
          </div>
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
              ...
              <tbody class="bg-white dark:bg-neutral-800 divide-y divide-neutral-200 dark:divide-neutral-700">
                <tr v-for="room in reportData.summary.roomPerformance" :key="room.type" class="hover:bg-neutral-50 dark:hover:bg-neutral-700">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      ...
                      <span class="text-sm text-neutral-900 dark:text-neutral-100">{{ room.occupancy }}%</span>
                    </div>
                  </td>
                </tr>
              </tbody>
      ...
      <!-- Empty State -->
      <div v-else-if="selectedHotelId && !loading && reportData.bookings.length === 0" class="text-center py-12">
        <svg class="mx-auto h-12 w-12 text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">No bookings found for the selected date range.</p>
      </div>
      ...
      <div v-else-if="!selectedHotelId" class="text-center py-12">
        ...
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Choose a hotel and date range to generate reports.</p>
      </div>
    </div>
  </div>
</template>
...
const calculateSummary = () => {
  ...
  reportData.value.summary.avgDailyRate = bookings.length > 0 
    ? Math.round(reportData.value.summary.totalRevenue / bookings.length)
    : 0
  ...
  reportData.value.summary.statusBreakdown = Object.entries(statusCounts).map(([status, count]) => ({
    name: status,
    count,
