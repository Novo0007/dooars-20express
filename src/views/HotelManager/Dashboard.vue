  ...
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-900 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8 bg-white dark:bg-neutral-800 rounded-xl shadow-soft p-6 border border-neutral-200 dark:border-neutral-700">
        <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-4">Your Assigned Hotels</h3>
        ...
        <div v-if="authStore.hotelAssignments.length === 0" class="text-center py-8">
          ...
          <h3 class="mt-2 text-sm font-medium text-neutral-900 dark:text-neutral-100">No hotels assigned</h3>
          <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Contact your administrator to assign hotels to your account.</p>
        </div>
      </div>
      ...
      <div v-if="selectedHotel">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4 flex-1">
                ...
                <div class="flex items-center mt-1">
                  <svg v-if="stat.changeType === 'increase'" class="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-soft border border-neutral-200 dark:border-neutral-700 overflow-hidden mb-8">
          ...
          <div v-if="recentBookings.length === 0" class="text-center py-8">
            ...
            <h3 class="mt-2 text-sm font-medium text-neutral-900 dark:text-neutral-100">No recent bookings</h3>
            <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Bookings for this hotel will appear here.</p>
          </div>
        </div>
      </div>
    </div>
...
const calculateHotelStats = async () => {
  ...
  try {
    ...
    const totalRevenue = monthlyRevenue?.reduce((sum, booking) => sum + (booking.final_price || 0), 0) || 0
