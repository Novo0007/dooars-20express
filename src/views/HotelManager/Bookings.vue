<template>
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-900 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
              ...
              >
                ...
                >
                  <td
                    class="px-6 py-4 whitespace-nowrap text-sm font-mono text-neutral-900 dark:text-neutral-100"
                  >
                    #{{ booking.id.slice(-8) }}
                  </td>
      ...
      <!-- Empty State -->
      <div
        v-else-if="selectedHotelId && !loading && bookings.length === 0"
...
const totalRevenue = computed(() =>
  bookings.value.reduce((sum, b) => sum + (b.final_price || 0), 0),
)
...
const getSelectedHotelName = () => {
  const assignment = authStore.hotelAssignments.find(
    (a) => a.hotel.id.toString() === selectedHotelId.value,
  )
