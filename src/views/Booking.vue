<template>
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-900">
    <!-- Progress Indicator -->
    <div class="bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700 py-4">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="hidden sm:flex items-center space-x-2">
            <div class="flex items-center">
              ...
              <span class="ml-2 text-sm text-neutral-600 dark:text-neutral-400">{{ $t('booking.guestInfo') }}</span>
            </div>
            <div class="w-8 border-t border-neutral-300 dark:border-neutral-600"></div>
            <div class="flex items-center">
              <div class="w-8 h-8 border-2 border-neutral-300 dark:border-neutral-600 text-neutral-400 rounded-full flex items-center justify-center text-sm font-semibold">2</div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <form @submit.prevent="proceedToPayment" class="space-y-4">
              ...
              <div class="flex items-start space-x-3 pt-4">
                ...
                <label for="terms" class="text-sm text-neutral-600 dark:text-neutral-400">
                  ...
                  <a href="#" class="text-primary-600 dark:text-primary-400 hover:underline">{{ $t('booking.termsConditions') }}</a>
                  {{ $t('booking.and') }}
                  <a href="#" class="text-primary-600 dark:text-primary-400 hover:underline">{{ $t('booking.privacyPolicy') }}</a>
                </label>
              </div>
          ...
          <div v-if="currentStep === 'payment'" class="bg-white dark:bg-neutral-800 rounded-xl p-6">
            ...
            <div v-if="selectedPaymentMethod === 'razorpay'" class="space-y-4">
              ...
              <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                <h4 class="font-medium text-amber-800 dark:text-amber-200 mb-2">{{ $t('booking.testMode') }}</h4>
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <span v-else>
                {{ $t('booking.payNow') }} ${{ currentBooking?.finalPrice }}
              </span>
            </button>
          </div>
        </div>
...
const isGuestInfoValid = computed(() => {
  return guestInfo.value.firstName.trim() && 
...
const isPaymentValid = computed(() => {
  ...
  if (selectedPaymentMethod.value === 'card') {
    return cardInfo.value.number.trim() && 
